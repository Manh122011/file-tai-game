...
local Window = Fluent:CreateWindow({
    ...
    Theme = "Darker", -- Dark, Darker, Light, Aqua, Amethyst, Rose
...
--Create Tabs
    ...
    local DropdownSelectWeapon = Tabs.Main:AddDropdown("Chọn Vũ Khí", {
        Title = "Chọn",
        Values = {'Võ','Kiếm','Trái Ác Qủy'},
        Multi = false,
        Default = 1,
    })
    ...
    task.spawn(function()
        while wait() do
            pcall(function()
                ...
                elseif ChooseWeapon == " Trái Ác Qủy" then
                    for i ,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                        if v.ToolTip == "Trái Ác Qủy" then
                            if game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v.Name)) then
                                SelectWeapon = v.Name
                            end
                        end
    ...
    spawn(function()
      ...
      Tabs.Main:AddButton({
        ...
        Description = "Nhập Cất Cả Code X2",
        Callback = function()
            UseCode()
        end
    })
